...
SECRET_KEY = "django-insecure-!v0q9e6h(i0#dkkh2tvh^oq-jg#-wp+hym$%v5f=r*@@_#(cq6"
...
INSTALLED_APPS = [
    ...
    "pages",  # Custom app for the school management system
    "django_htmx",  # Optional: if using htmx for dynamic content
]
